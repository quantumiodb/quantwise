...
- **Language**: English (for technical terms) with Chinese summaries
...
```
请使用druckenmiller-strategy-planner智能体制定18个月战略。
...
并保存至reports/2025-11-03/druckenmiller-strategy.md。
```
...
4. druckenmiller-strategy-planner → 制定18个月战略」
```
